...
HRESULT CPlayer::Initialize(void * pArg)
{
	...
	if (FAILED(Add_Components()))
		return E_FAIL;
	m_pTransformCom->Set_Scale(((PLAYERDEC*)pArg)->Scale, ((PLAYERDEC*)pArg)->Scale, ((PLAYERDEC*)pArg)->Scale);
	m_pTransformCom->Rotation(XMVectorSet(0.f, 1.f, 0.f, 0.f), ((PLAYERDEC*)pArg)->RotationAngle);
...
void CPlayer::Set_Pos(_vector _pos)
{
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, _pos);
	XMStoreFloat4(&m_PlayerDec.Pos, _pos);
}
