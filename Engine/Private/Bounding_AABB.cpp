...
_bool CBounding_AABB::IntersectRay(_vector vRayOrigin, _vector vRayDirection, _float fDistance)
{
	m_isColl = false;
	m_isColl = m_pAABB->Intersects(vRayOrigin, vRayDirection, fDistance);
	return m_isColl;
}
