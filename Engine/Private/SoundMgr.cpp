...
HRESULT  CSoundMgr::PlayBGM(const TCHAR* pSoundKey, float fVolume)
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	...
	FMOD_Channel_SetPriority(m_pChannelArr[SOUND_BGM], 0);
...
void CSoundMgr::PlaySubBGM(const TCHAR* pSoundKey, _float fVolume)
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
...
void CSoundMgr::PlaySubBGM2(const TCHAR* pSoundKey, _float fVolume)
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	...
	FMOD_System_PlaySound(m_pSystem, iter->second, nullptr, FALSE, &m_pChannelArr[SOUND_BGM3]);
	FMOD_Channel_SetMode(m_pChannelArr[SOUND_BGM3], FMOD_LOOP_NORMAL);
	FMOD_Channel_SetVolume(m_pChannelArr[SOUND_BGM3], fVolume);
	FMOD_System_Update(m_pSystem);
...
_bool CSoundMgr::isSoundPlaying(CHANNELID eID)
{
